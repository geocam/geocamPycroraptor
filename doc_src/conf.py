...
version = geocamPycroraptor.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamPycroraptor.get_version()
...
htmlhelp_basename = 'geocamPycroraptordoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamPycroraptor Documentation',
   u'Trey Smith', 'manual'),
]
